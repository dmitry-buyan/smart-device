...
/* harmony import */ var _utils_spoller__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils/spoller */ "./js/utils/spoller.js");
/* harmony import */ var _vendor_mask__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./vendor/mask */ "./js/vendor/mask.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_utils_spoller__WEBPACK_IMPORTED_MODULE_2__["initSpoller"])();
    Object(_vendor_mask__WEBPACK_IMPORTED_MODULE_3__["initPhoneMask"])();
  });
}); // ---------------------------------
...
var Modals = /*#__PURE__*/function () {
  ...
  _createClass(Modals, [{
    ...
    key: "_autoFocus",
    value: function _autoFocus(modal) {
...
var initSpoller = function initSpoller() {
  ...
  var setSpollerAction = function setSpollerAction(evt) {
    var el = evt.target;
  ...
  var initSpollers = function initSpollers(spollers) {
    var matchMedia = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
    spollers.forEach(function (spollersBlock) {
  ...
  if (spollersArray.length) {
    ...
    var spollersMedia = Array.from(spollersArray).filter(function (item) {
      return item.dataset.spollers.split(',')[0];
    ...
    if (spollersMedia.length) {
      ...
      mediaQueries.forEach(function (breakpoint) {
        ...
        var spollers = breakpointsArray.filter(function (item) {
          return item.value === mediaBreakpoint && item.type === mediaType;
        }); // Событие

        matchMedia.addEventListener('change', function () {
          return initSpollers(spollers, matchMedia);
        });
...
var initPhoneMask = function initPhoneMask() {
  var phoneFields = document.querySelectorAll('[data-user-phone]');
  var maskOptions = {
    mask: '+{7}(000)000-00-00'
  };
  phoneFields.forEach(function (phoneField) {
    return Object(imask__WEBPACK_IMPORTED_MODULE_0__["default"])(phoneField, maskOptions);
  });
};
